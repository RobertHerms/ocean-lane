...
export const WALLS = [
  // ---- exterior ----
  wx(0, 0, 35, ALL, [loWin(20.8, 24.2), loWin(30.5, 33.5),   // half-bath window: wide (photos 46-48)
  ...
  wz(20.8, 30.25, 35, [MAIN_CEIL - 0.07, MAIN_CEIL], [], { ...EXT, t: WALL_T }),   // closes the attic void above the porch ceiling (flush with the eave bottom, 17.93: PORCH in house.js)
...
export const FLOORS = [
  ...
  { r: [20.6, 29.05, 43.5, 51.95], h: 1.875 },        // stoop lower landing: square, where the railings end
  { r: [19.4, 20.6, 45.5, 51.95], h: 1.25 },          // two steps down its west side onto the drive (upper)
  { r: [18.2, 19.4, 45.5, 51.95], h: 0.625 },         //   (lower)
...
export const SOLIDS = [
  ...
  { b: [20.6, 29.05, 0, 1.875, 43.5, 51.95], mat: 'ledgestone', top: 'bluestone', ext: true },   // square lower landing (the garden bed wraps its south and east sides)
  { b: [19.4, 20.6, 0, 1.25, 45.5, 51.95], mat: 'ledgestone', top: 'bluestone', ext: true },    // steps down its west side to the drive: upper
  { b: [18.2, 19.4, 0, 0.625, 45.5, 51.95], mat: 'ledgestone', top: 'bluestone', ext: true },   //   lower
